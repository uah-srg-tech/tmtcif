 ...
 ******************************************************************************/
package es.uah.aut.srg.tmtcif.lang.imports.ide.contentassist.antlr;

import com.google.inject.Inject;
import es.uah.aut.srg.tmtcif.lang.imports.ide.contentassist.antlr.internal.InternalIMPORTSParser;
...
public class IMPORTSParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalIMPORTSParser createParser() {
		InternalIMPORTSParser result = new InternalIMPORTSParser(null);
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			InternalIMPORTSParser typedParser = (InternalIMPORTSParser) parser;
