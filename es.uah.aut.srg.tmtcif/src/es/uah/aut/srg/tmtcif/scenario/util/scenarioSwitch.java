...
public class scenarioSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case scenarioPackage.TMTCIF_SCENARIO: {
				TMTCIFScenario tmtcifScenario = (TMTCIFScenario)theEObject;
				T result = caseTMTCIFScenario(tmtcifScenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scenarioPackage.TMTCIF_SCENARIO_INTERFACE: {
				TMTCIFScenarioInterface tmtcifScenarioInterface = (TMTCIFScenarioInterface)theEObject;
				T result = caseTMTCIFScenarioInterface(tmtcifScenarioInterface);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case scenarioPackage.TMTCIF_SCENARIO_VARIABLE: {
				TMTCIFScenarioVariable tmtcifScenarioVariable = (TMTCIFScenarioVariable)theEObject;
				T result = caseTMTCIFScenarioVariable(tmtcifScenarioVariable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
