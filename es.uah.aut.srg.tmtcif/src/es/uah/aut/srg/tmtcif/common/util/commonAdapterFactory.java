...
public class commonAdapterFactory extends AdapterFactoryImpl {
	...
	protected commonSwitch<Adapter> modelSwitch =
		new commonSwitch<Adapter>() {
			@Override
			public Adapter caseTMTCIFModelFile(TMTCIFModelFile object) {
				return createTMTCIFModelFileAdapter();
			}
			@Override
			public Adapter caseTMTCIFModelFileImport(TMTCIFModelFileImport object) {
				return createTMTCIFModelFileImportAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.tmtcif.common.TMTCIFModelFile <em>TMTCIF Model File</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTMTCIFModelFileAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link es.uah.aut.srg.tmtcif.common.TMTCIFModelFileImport <em>TMTCIF Model File Import</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTMTCIFModelFileImportAdapter() {
		return null;
	}
