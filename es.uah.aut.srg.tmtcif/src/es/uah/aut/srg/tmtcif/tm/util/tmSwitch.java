 ...
 */
package es.uah.aut.srg.tmtcif.tm.util;
...
public class tmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case tmPackage.TMTCIFTM: {
				TMTCIFTM tmtciftm = (TMTCIFTM)theEObject;
				T result = caseTMTCIFTM(tmtciftm);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case tmPackage.TMTCIFPI1: {
				TMTCIFPI1 tmtcifpi1 = (TMTCIFPI1)theEObject;
				T result = caseTMTCIFPI1(tmtcifpi1);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case tmPackage.TMTCIFTM_FIELD: {
				TMTCIFTMField tmtciftmField = (TMTCIFTMField)theEObject;
				T result = caseTMTCIFTMField(tmtciftmField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
