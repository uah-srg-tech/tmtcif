...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>TMTCIF Format Array Ref</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.tmtcif.format.impl.TMTCIFFormatArrayRefImpl#getFidRef <em>Fid Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TMTCIFFormatArrayRefImpl extends MinimalEObjectImpl.Container implements TMTCIFFormatArrayRef {
	/**
	 ...
	 * @generated
	 */
	protected TMTCIFFormatArrayRefImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return formatPackage.Literals.TMTCIF_FORMAT_ARRAY_REF;
	}
	...
	public void setFidRef(String newFidRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, formatPackage.TMTCIF_FORMAT_ARRAY_REF__FID_REF, oldFidRef, fidRef));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case formatPackage.TMTCIF_FORMAT_ARRAY_REF__FID_REF:
				return getFidRef();
		}
